...
abstract class IPlaceRepository {
  Future<void> addPlace(final Place place);
  Future<void> getPlacesList();
  Future<void> getPlaceByID(final int id);
  Future<void> updatePlaceByID(final Place place);
  ...
  Future<void> uploadFile(final String bytes);
  ...
  Future<void> getFilteredPlaces(final PlacesFilterRequestDto filter);
}
